...
class Bird(pygame.Rect): #inheritance, to detect collition
...
pipes = []
velocity_x = -2 #move pipes to the left speed to stimulates bird moving right
...
def move():
    ...
    velocity_y += gravity
    bird.y += velocity_y
    bird.y = max(bird.y, 0) #limit bird to top 
    ...
    for pipe in pipes:
        ...
        if bird.colliderect(pipe):
            game_over = True
            return
    #delete pipes that moved off left side of screen
